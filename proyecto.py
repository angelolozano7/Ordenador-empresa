...
def reservarValla():
    global ubicacion,vAcumulado,vOcupado,vReservado,vDisponible,tVallas,infoValla,reservar,clienteR,agenciaR,valorSinDescuento,valorConDescuento,duracionR,fechaInicio,fechaFinal#,referencia
    ...
    e1=tk.Label(reservar,text="Gestion reserva de la valla referencia",font=("helvetica",19),bg="white").place(x=350,y=40)
    #creacion labels
    ...
    cliente=tk.Entry(reservar,font=("helvetica",14)).place(x=150,y=200)
    agencia=tk.Entry(reservar,font=("helvetica",14)).place(x=150,y=250)
    valorT=tk.Entry(reservar,font=("helvetica",14)).place(x=180,y=300)
    valorD=tk.Entry(reservar,font=("helvetica",14)).place(x=640,y=200)
    duracion=tk.Entry(reservar,font=("helvetica",14)).place(x=550,y=250)
    fechaIni=tk.Entry(reservar,font=("helvetica",14)).place(x=570,y=300)
    fechaFin=tk.Entry(reservar,font=("helvetica",14)).place(x=570,y=350)
...
def hacerReserva():
    global reservar,clienteR,agenciaR,valorSinDescuento,valorConDescuento,duracionR,fechaInicio,fechaFinal#,referencia
    reservar.withdraw()
    #en esta funcion debemos abrir el archivo de reservas y escribir esta reserva
    #podemos direccionarlo al menu de vallas y mostrarle un message box diciendo que la reserva fue exitosa
    Vallas.deiconify()


def arrendarValla():
    global ubicacion,vAcumulado,vOcupado,vReservado,vDisponible,tVallas,infoValla,arrendar,clienteR,agenciaR,valorSinDescuento,valorConDescuento,duracionR,fechaInicio,fechaFinal#,referencia
    ...
    e1=tk.Label(arrendar,text="Gestion arriendo de la valla referencia",font=("helvetica",19),bg="white").place(x=350,y=40)
    #creacion labels
    ...
    #creacion campos de entrada
    cliente=tk.Entry(arrendar,font=("helvetica",14)).place(x=150,y=200)
    agencia=tk.Entry(arrendar,font=("helvetica",14)).place(x=150,y=250)
    valorT=tk.Entry(arrendar,font=("helvetica",14)).place(x=180,y=300)
    valorD=tk.Entry(arrendar,font=("helvetica",14)).place(x=640,y=200)
    duracion=tk.Entry(arrendar,font=("helvetica",14)).place(x=550,y=250)
    fechaIni=tk.Entry(arrendar,font=("helvetica",14)).place(x=570,y=300)
    fechaFin=tk.Entry(arrendar,font=("helvetica",14)).place(x=570,y=350)
    #obtencion de datos campos de entrada
    clienteR=cliente.get()#problema con el .get
    agenciaR=agencia.get()
    valorSinDescuento=valorT.get()
    valorConDescuento=valorD.get()
    duracionR=duracion.get()
...
def hacerPauta():
    global arrendar,clienteR,agenciaR,valorSinDescuento,valorConDescuento,duracionR,fechaInicio,fechaFinal#,referencia
    arrendar.withdraw()
    #en esta funcion debemos abrir el archivo de reservas y escribir esta reserva
